...
For reference, the "at" sign (@, or the \ita{arroba}) is informally used to make terms gender neutral; don't use this for anything formal, like written work. That's why in the previous conjugation charts I used \ita{nosotr@s} in the place of \ita{nosotros} and \ita{nosotras}. 
