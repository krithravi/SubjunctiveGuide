...
\begin{conf}{@: \ita{La arroba}}
	For reference, the "at" sign (@, or the \ita{arroba}) is informally used to make terms gender neutral; don't use this for anything formal, like written work. In the previous conjugation charts, I used \ita{nosotr@s} to avoid having to say \ita{nosotros} and \ita{nosotras}. The \ita{arroba} will be used for the rest of the guide to indicate gender neutrality.
\end{conf}
