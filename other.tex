...
\subsection{However}
To say ``however,'' use the construction \ita{como + verbo}, where the verb is conjugated in the subjunctive. For example, the sentence ``You can do it however you want'' can be translated as \ita{Puedes hacerlo como quieras.} 
